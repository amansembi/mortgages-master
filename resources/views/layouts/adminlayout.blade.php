...
<head>
  ...
  <title>Mortgages Master Dashboard</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{url('/')}}" class="brand-link">
      ...
      style="opacity: .8">
      <span class="brand-text font-weight-light">Mortgages Master</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="post-menu nav-item has-treeview">
            <a href="{{url('admin/post/allpost')}}" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{url('admin/post/allpost')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All posts</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('admin/postCategory')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Categorise</p>
                </a>
              </li>
          ...
          <li class="custom_fields nav-item has-treeview">
            <a href="{{url('admin/addCustomField')}}" class="nav-link">
			...
			<ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('admin/addCustomField')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Love To Meet You</p>
                </a>
              </li>   
			  <li class="nav-item">
                <a href="{{url('admin/firstTimeBuyers')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="testimonial nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('admin/alltestimonial')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All testimonials</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('admin/newtestimonial')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add new</p>
                </a>
              </li>  
        ...
        <ul class="navbar-nav ml-auto">
          ...
          @guest
          <li class="nav-item">
            <a class="nav-link" href="{{ route('layouts/login') }}">{{ __('Login') }}</a>
          </li>
          @if (Route::has('register'))
          <li class="nav-item">
            <a class="nav-link" href="{{ route('layouts/register') }}">{{ __('Register') }}</a>
          </li>
          @endif
          @else
          <li class="nav-item dropdown">

		  ...
		  <section class="content-header">
			  <div class="row">			  
				  ...
				  <div class="card card-outline card-info">
					<div class="col-md-5">
					@if(Session::get('firstTimeBuyersPost'))       
				  <div class="alert alert-success">
					<button class="close" data-dismiss="alert">x</button>
					<strong>{{Session::get('firstTimeBuyersPost')}}    </strong>
				  </div>
				  @endif
					@if(count($errors) > 0)
					  ...
					  @endforeach
					  @endif
						<form class="custom_fields" enctype="multipart/form-data" method="post" action="{{url('admin/firstTimeBuyers')}}">
						@csrf
							<div class="form-group">
							  <label for="posttitle">First Time Buyers</label> 
